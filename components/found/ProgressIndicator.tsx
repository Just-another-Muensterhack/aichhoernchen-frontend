                    ...
                    <li key={step.name} className={`relative ${stepIdx !== steps.length - 1 ? 'pr-8 sm:pr-20' : ''}`}>
                        {currentStep > step.id ? (
                            ...
                            <>
                                ...
                                <a href="#" className="relative flex h-8 w-8 items-center justify-center bg-white border-2 border-primary rounded-full" aria-current="step">
                            ...
                            <>
                                ...
                                <a href="#" className="group relative flex h-8 w-8 items-center justify-center bg-white border-2 border-gray-300 rounded-full hover:border-gray-400">
                                    <span className="h-2.5 w-2.5 bg-transparent rounded-full group-hover:bg-gray-300" aria-hidden="true" />
                                    <span className="sr-only text-gray-700">{step.name}</span>
                                </a>
                            </>
                        )}
                        <p className="absolute -bottom-6 text-gray-700 text-xs text-center w-20 -left-6">{step.name}</p>
                    </li>
                ))}
            </ol>
        </nav>
